...
export default function LessonPage(){
  ...
  function completeLesson(){
    markLessonComplete("english-a1-lesson-1");
    setCompleted(true);
  }
  ...
  return <div>
    ...
    <div className={styles.lessonLayout}>
      <main className={styles.lessonContent}>
        ...
        {completed && <section className={styles.panel}><span className={styles.eyebrow}>LESSON COMPLETE</span><h2>Great work — Lesson 1 is complete.</h2><p>Your result is now stored in your AIRA learner profile on this device and appears in the Progress section.</p><Link href="/learn/practice" className={styles.primaryButton}>Continue to conversation practice →</Link></section>}
